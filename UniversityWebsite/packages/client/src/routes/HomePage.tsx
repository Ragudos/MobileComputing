            ...
            <main className={combineClassesOrNone("container")}>
                <section className={homepageStyles.heroBackground}>
                    <BlurText
                        ...
                        className={combineClassesOrNone("h1", homepageStyles.blurText)}
                    />
                    <BlurText
                        ...
                        direction="top"
                        onAnimationComplete={handleAnimationComplete}
                        className={combineClassesOrNone("p", homepageStyles.paraText)}
                    />
                    <Button variant="primary" onClick={() => navigate('/auth/login')}>Apply Now!</Button>
                </section>

                <section className={homepageStyles.missionSection}>
                    <div className={homepageStyles.row1}>
                        <h4>A Mission Defined by Possibility</h4>
                        <p className={homepageStyles.paraSec2}>At Sigma, our mission of discovery and learning is energized by a spirit of optimism and possibility that dates to our founding. Here you’ll find a place of intellectual expansiveness, wide-ranging perspectives, and freedom to explore new lines of thinking. Buzzing with ideas and innovation, approaching questions with openness and curiosity, pursuing excellence in all we do – this is Sigma.</p>
                        <Button variant="primary" onClick={() => navigate('/about')} className={homepageStyles.but}>More about Sigma</Button>
                    </div>
                    <div className={homepageStyles.imageContainer}>
                        <img src='/sec2pic.jpg' className={homepageStyles.section2Image}></img>
                    </div>
                </section>
                <section className={homepageStyles.bentoSection}>
                    <h3 className={homepageStyles.bentoTitle}>Explore Our Programs</h3>
                    <p className={homepageStyles.bentoSubtitle}>Our academic offerings are designed to balance theory, practice, and innovation.</p>
                ...
                <section className={homepageStyles.advantageSection}>
                    <h3 className={homepageStyles.advantageTitle}>The Sigma Advantage</h3>
                    <ul className={homepageStyles.advantageList}>
                        <li className={homepageStyles.advantageItem}>Cutting-edge curriculum designed with industry leaders</li>
                        <li className={homepageStyles.advantageItem}>State-of-the-art labs, libraries, and digital resources</li>
                        <li className={homepageStyles.advantageItem}>Experienced faculty and global partnerships</li>
                        <li className={homepageStyles.advantageItem}>Strong focus on leadership, ethics, and innovation</li>
                        <li className={homepageStyles.advantageItem}>A vibrant student community with 50+ clubs and organizations</li>
                    </ul>
                    <Button variant="primary" onClick={() => navigate('/auth/login')} className={homepageStyles.but}>Apply Now!</Button>
                </section>
                <section className={homepageStyles.lifeSection}>
                    <div className={homepageStyles.lifeImageRow}>
                        <img src="/sec5img.jpg" alt="Life at Sigma" className={homepageStyles.lifeImage} />
                    </div>
                    <div className={homepageStyles.lifeTextRow}>
                        <h3>Life at Sigma</h3>
                        <p>Sigma University is more than just classrooms and exams—it’s a hub of creativity, collaboration, and personal growth.</p>
                        <ul className={homepageStyles.lifeList}>
                            <li>Modern dormitories & eco-friendly campus</li>
                            <li>Sports facilities, gyms, and wellness programs</li>
                            <li>Cultural events, hackathons, and leadership summits</li>
                        </ul>
                        <Button variant="primary" onClick={() => navigate('/auth/login')} >Apply Now!</Button>
                    </div>
                </section>
                <section className={homepageStyles.testimonialSection}>
                    <h3 className={homepageStyles.testimonialTitle}>Hear From Our Students</h3>
                    <div className={homepageStyles.testimonialCarousel}>
                        ...
                        <div className={homepageStyles.testimonialCard}>
                            {testimonials[testimonialIndex] ? (
                                <>
                                    <p className={homepageStyles.testimonialQuote}>
                                        “{testimonials[testimonialIndex].quote}”
                                    </p>
                                    <span className={homepageStyles.testimonialAuthor}>
                        ...
                        {testimonials.map((_, idx) => (
                            <span
                                ...
                                style={{
                                    ...
                                    height: 10,
                                    borderRadius: '50%',
                                    background: idx === testimonialIndex ? 'var(--brand-color, #0057B8)' : '#cce0f6',
                ...
                <section className={homepageStyles.journeySection}>
                    ...
                    <p>Join a community of thinkers, innovators, and leaders at Sigma University.</p>
                    <Button variant="default" className={homepageStyles.but} onClick={() => navigate('/auth/login')}>Start Your Application</Button>
                </section>
            </main>
        </ClickSpark>
